...
import { InventoryItemsView } from '@/modules/inventory/pages/admin/InventoryItemsView';
import { InventoryNewItemView } from '@/modules/inventory/pages/admin/InventoryNewItemView';
import { InventoryEntryView } from '@/modules/inventory/pages/admin/InventoryEntryView';
import { InventoryCountView } from '@/modules/inventory/pages/admin/InventoryCountView';
import { InventorySuppliersView } from '@/modules/inventory/pages/admin/InventorySuppliersView';
import { InventoryLogsView } from '@/modules/inventory/pages/admin/InventoryLogsView';
