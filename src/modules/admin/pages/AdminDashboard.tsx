...
import { 
    ...
    Bell, Search, Moon, Sun, TrendingUp, Users,
    ShoppingBag, AlertCircle, CheckCircle, ArrowLeft
} from 'lucide-react';
...
export const AdminDashboard: React.FC = () => {
    ...
    const toggleDarkMode = () => {
        ...
        // Aqui você pode adicionar a lógica para aplicar o tema escuro
    };
        ...
        <div className={`flex flex-col h-screen ${isDarkMode ? 'dark' : ''} overflow-hidden font-sans`}>
            ...
            <header className="bg-gradient-to-r from-slate-900 to-slate-800 text-white shadow-xl shrink-0 z-30 relative">
                <div className="w-full mx-auto">
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div className="hidden sm:block">
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    <span className="text-[9px] sm:text-[10px] font-bold bg-purple-600 px-2 py-0.5 rounded-full uppercase tracking-wider backdrop-blur-sm">
                                        Gestor
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="relative user-menu">
                                ...
                                >
                                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-md">
                                ...
                                {isUserMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-50 border border-gray-100 animate-fadeIn">
                                        <div className="px-4 py-3 border-b border-gray-100">
                                            ...
                                            <p className="text-[10px] text-purple-600 mt-1 font-medium">Administrador</p>
                                        </div>
                                        <Link
                                            to="/manual"
                                            target="_blank"
                    ...
                    {isMobileMenuOpen && (
                        <div className="lg:hidden bg-slate-800/95 backdrop-blur-lg border-t border-slate-700/50 animate-slideDown">
                            <div className="px-4 py-3 space-y-1">
                                ...
                                <div className="pt-3 mt-2 border-t border-slate-700/50">
                                    <Link
                                        to="/manual"
                                        target="_blank"
                                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-white/10 transition-all duration-200"
                                    >
                                        <BookOpen size={18} />
                            ...
                            {visibleTabs.map(tab => {
                                ...
                                return (
                                    <Link 
                                        ...
                                        `}
                                    >
                                        <tab.icon size={18} className={`transition-transform group-hover:scale-110 ${isActive ? 'text-purple-400' : ''}`} />
                                        <span>{tab.label}</span>
                                        {isActive && (
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    {currentTab && (
                        <>
                            <currentTab.icon size={16} className="text-purple-600" />
