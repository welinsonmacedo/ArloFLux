...
import { DailyLogTab } from '@/modules/staff/pages/admin/DailyLogTab';
import { PointCorrectionTab } from '@/modules/staff/pages/admin/PointCorrectionTab';
import { SendToPayrollTab } from '@/modules/staff/pages/admin/SendToPayrollTab';
