            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                        {orderState.orders.filter((o: any) => o.status === 'PENDING').length === 0 && (
                            <p className="text-center py-10 text-gray-400 italic">Nenhum pedido pendente.</p>
                        )}
                        {orderState.orders.filter((o: any) => o.status === 'PENDING').map((order: any) => (
                ...
                <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {invState.inventory.filter((i: any) => i.quantity <= i.minQuantity).slice(0, 8).map((item: any) => (
