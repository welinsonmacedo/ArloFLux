            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-2 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                        {orderState.orders.filter((o: any) => o.status !== 'DELIVERED' && o.status !== 'CANCELLED').map((order: any) => {
                        ...
                        {orderState.orders.filter((o: any) => o.status !== 'DELIVERED' && o.status !== 'CANCELLED').length === 0 && (
                ...
                <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-2">
                        {invState.inventory.filter((i: any) => i.quantity <= i.minQuantity).slice(0, 5).map((item: any) => (
                        ...
                        {invState.inventory.filter((i: any) => i.quantity <= i.minQuantity).length === 0 && (
