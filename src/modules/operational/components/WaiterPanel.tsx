            ...
            {orderState.serviceCalls.length > 0 && (
                <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        {orderState.serviceCalls.map((call: any) => {
                            const table = orderState.tables.find((t: any) => t.id === call.tableId);
                            return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        {orderState.orders.slice(0, 10).map((order: any) => (
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        {invState.inventory.slice(0, 10).map((item: any) => (
