...
import { CommercePOS } from '@/modules/operational/pages/commerce/CommercePOS';
import { CommerceHistoryView } from '@/modules/operational/pages/commerce/CommerceHistoryView';
