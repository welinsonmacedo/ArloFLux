...
├── 01_core.sql          # Tenants, Users, Audit Logs
├── 02_hr.sql            # Staff, Roles, Shifts, Payroll
├── 03_inventory_menu.sql# Inventory, Suppliers, Menu
├── 04_orders.sql        # Tables, Orders, Service Calls
├── 05_finance.sql       # Cash Sessions, Transactions, Expenses
└── 06_triggers_rpcs.sql # Database Functions and Triggers
